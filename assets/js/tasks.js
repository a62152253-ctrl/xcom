...
function openCreateProjectModal() {
    ...
    const defaultColorEl = document.querySelector('.color-option[data-color="#3b82f6"]');
    if (defaultColorEl) {
        defaultColorEl.style.borderColor = 'var(--primary)';
    }
...
function selectProjectColor(color) {
    ...
    const selectedColorEl = document.querySelector(`.color-option[data-color="${color}"]`);
    if (selectedColorEl) {
        selectedColorEl.style.borderColor = 'var(--primary)';
    }
}
