...
function openCreateProjectModal() {
    ...
    document.getElementById('color-' + '5a39641bfb9b008d3abdc263e6e61f23').style.borderColor = 'var(--primary)';
...
function selectProjectColor(color, hash) {
    document.getElementById('project-color').value = color;
    document.querySelectorAll('[id^="color-"]').forEach(c => c.style.borderColor = 'transparent');

    if (hash) { document.getElementById('color-' + hash).style.borderColor = 'var(--primary)'; } else { document.getElementById('color-5a39641bfb9b008d3abdc263e6e61f23').style.borderColor = 'var(--primary)'; }
}
