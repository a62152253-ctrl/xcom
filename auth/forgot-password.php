        ...
        if (empty($email)) {
            ...
            try {
                ...
                if ($user) {
                    ...
                    $reset_link = (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]/auth/forgot-password.php?step=reset&token=$reset_token";
                    send_email($email, 'Reset hasła - TaskManager Pro', "Kliknij w poniższy link, aby zresetować hasło:<br><br><a href=\"$reset_link\">$reset_link</a>");
