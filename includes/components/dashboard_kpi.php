...
<div class="pkpi-grid">
    ...
    <div class="pkpi-card" style="--pkpi-color:#6366f1;--pkpi-light:rgba(99,102,241,.1);--pkpi-grad:linear-gradient(90deg,#6366f1,#8b5cf6);--pkpi-glow:rgba(99,102,241,.1)" onclick="window.location.href='/pages/projects.php'" onkeydown="if(event.key==='Enter') window.location.href='/pages/projects.php'" tabindex="0" role="button">
        <div class="pkpi-top">
    ...
    <div class="pkpi-card" style="--pkpi-color:#06b6d4;--pkpi-light:rgba(6,182,212,.1);--pkpi-grad:linear-gradient(90deg,#06b6d4,#0ea5e9);--pkpi-glow:rgba(6,182,212,.1)" onclick="window.location.href='/pages/tasks.php'" onkeydown="if(event.key==='Enter') window.location.href='/pages/tasks.php'" tabindex="0" role="button">
        <div class="pkpi-top">
