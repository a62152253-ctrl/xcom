...
<head>
    ...
    <style>
        /* Small style tweaks for general layout integration */
    ...
    <div class="app-wrapper">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-footer">
                ...
                <a href="/auth/logout.php" title="<?php echo __('logout'); ?>" style="color: var(--text-secondary);"><i class="fa-solid fa-right-from-bracket"></i></a>
            </div>
        </aside>
        ...
        <div class="main-content">
            ...
            <header class="top-bar">
                <div class="search-bar">
                    ...
                    <div id="search-results" style="display: none; position: absolute; top: 45px; left: 0; right: 0; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: var(--radius-md); box-shadow: var(--shadow-lg); z-index: 1000; max-height: 250px; overflow-y: auto; padding: 0.5rem;"></div>
                </div>
            ...
            <div class="notification-dropdown" id="notif-dropdown">
                <div style="padding: 1rem; border-bottom: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center;">
                    <strong style="font-size: 0.9rem;">Powiadomienia</strong>
                    <span style="font-size: 0.75rem; color: var(--primary); cursor: pointer;" onclick="markAllNotificationsAsRead()">Oznacz jako przeczytane</span>
                </div>
