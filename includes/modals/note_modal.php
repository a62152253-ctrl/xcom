<div class="modal-overlay" id="note-modal">
    <div class="modal-window" style="max-width:560px">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" onclick="closeNoteModal()" style="width:auto">Anuluj</button>
            <button type="button" class="btn btn-primary" onclick="saveNote()" style="width:auto"><i class="fa-solid fa-floppy-disk"></i> Zapisz</button>
        </div>
    </div>
</div>