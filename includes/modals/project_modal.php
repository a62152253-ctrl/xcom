        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                    ...
                    <div style="width: 40px; height: 40px; background: <?= $c ?>; border-radius: 8px; cursor: pointer; border: 3px solid transparent; transition: all 0.2s;" role="button" tabindex="0" onclick="selectProjectColor('<?= $c ?>')" id="color-<?= md5($c) ?>" aria-label="Wybierz kolor"></div>
                    <?php endforeach; ?>
