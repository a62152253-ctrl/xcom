        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                    ...
                    <button type="button" aria-label="Select color <?= htmlspecialchars($c, ENT_QUOTES, 'UTF-8') ?>" style="width: 40px; height: 40px; background: <?= htmlspecialchars($c, ENT_QUOTES, 'UTF-8') ?>; border-radius: 8px; cursor: pointer; border: 3px solid transparent; transition: all 0.2s; padding: 0;" onclick="selectProjectColor('<?= htmlspecialchars($c, ENT_QUOTES, 'UTF-8') ?>')" id="color-<?= md5($c) ?>"></button>
                    <?php endforeach; ?>
