...
<!-- Files grid -->
<?php if (empty($files)): ?>
<div class="empty-state-premium" style="max-width:420px;margin:40px auto;grid-column:1/-1">
    <div class="es-icon">📂</div>
    <div class="es-title">Brak plików</div>
    <div class="es-sub">Pliki pojawią się tutaj po dodaniu załączników do zadań. Przejdź do zadań, aby dodać pierwszy plik!</div>
    <a href="/pages/tasks.php" class="es-btn"><i class="fa-solid fa-list-check"></i> Przejdź do zadań</a>
</div>
<?php else: ?>
