...
<div class="logs-container">
    ...
    <div class="logs-main">
        ...
        <div class="empty-state-premium">
            ...
            <div class="es-sub">Brak logów do wyświetlenia dla podanych kryteriów. Spróbuj zmienić filtry.</div>
            <a href="/pages/logs.php" class="es-btn"><i class="fa-solid fa-rotate-left"></i> Wyczyść filtry</a>
        </div>
        <?php else: ?>
