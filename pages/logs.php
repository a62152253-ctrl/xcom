...
<div class="logs-container">
    ...
    <div class="logs-main">
        ...
        <div class="empty-state-premium">
            ...
            <div class="es-sub">Spróbuj zmienić parametry filtrowania lub wykonaj kilka akcji w systemie, aby wygenerować logi.</div>
            <a href="/pages/logs.php" class="es-btn"><i class="fa-solid fa-redo"></i> Wyczyść filtry</a>
        </div>
        <?php else: ?>
