...
<div class="logs-container">
    ...
    <div class="logs-main">
        ...
        <div class="empty-state-premium" style="max-width:400px;margin:40px auto">
            ...
            <div class="es-sub">Nie zarejestrowano jeszcze żadnej aktywności w systemie lub filtry są zbyt rygorystyczne.</div>
            <a href="/pages/logs.php" class="es-btn"><i class="fa-solid fa-rotate-right"></i> Zresetuj filtry</a>
        </div>
        <?php else: ?>
