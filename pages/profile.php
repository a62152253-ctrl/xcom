    ...
    <div class="card" style="margin-bottom:0">
        ...
        <div style="display:flex;flex-direction:column;gap:0">
            ...
            <div class="empty-state-premium" style="padding:2rem">
                ...
                <div class="es-sub">Nie masz jeszcze żadnych logów w systemie.</div>
                <a href="/pages/dashboard.php" class="es-btn"><i class="fa-solid fa-arrow-right"></i> Przejdź do dashboardu</a>
            </div>
            <?php else: ?>
