    ...
    <div class="card" style="margin-bottom:0">
        ...
        <div style="display:flex;flex-direction:column;gap:0">
            ...
            <div class="empty-state-premium" style="max-width: 400px; margin: 40px auto;">
                ...
                <div class="es-sub">Nie zapisano jeszcze żadnych działań dla tego konta.</div>
                <a href="/pages/dashboard.php" class="es-btn"><i class="fa-solid fa-home"></i> Wróć do panelu</a>
            </div>
            <?php else: ?>
