    ...
    <div class="card" style="margin-bottom:0">
        ...
        <div style="display:flex;flex-direction:column;gap:0">
            ...
            <div class="empty-state-premium" style="padding:2rem">
                ...
                <div class="es-sub">Wydaje się, że nie ma jeszcze żadnych aktywności w tym projekcie.</div>
                <a href="/pages/tasks.php" class="es-btn"><i class="fa-solid fa-check"></i> Przejdź do zadań</a>
            </div>
            <?php else: ?>
