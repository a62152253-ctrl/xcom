...
<div class="empty-state-premium" style="grid-column:1/-1; max-width: 400px; margin: 40px auto;">
    ...
    <div class="es-sub">Spróbuj innych słów kluczowych lub zmień filtr.</div>
    <a href="/pages/dashboard.php" class="es-btn"><i class="fa-solid fa-arrow-left"></i> Wróć do panelu</a>
</div>
<?php else: ?>
