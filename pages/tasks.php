...
<?php require_once __DIR__ . '/../includes/modals/project_create.php'; ?>
<?php require_once __DIR__ . '/../includes/modals/task_edit.php'; ?>
...
// Project creation functions (using the shared project_create.php modal)
